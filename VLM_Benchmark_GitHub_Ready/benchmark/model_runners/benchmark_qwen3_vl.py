...
# -*- coding: utf-8 -*-
"""
Qwen3-VL-8B-Instruct Benchmark Script
"""
...
@torch.no_grad()
def generate_answer_qwen3(model, processor, image: Image.Image, human_prompt: str, max_new_tokens: int) -> str:
    """使用 Qwen3-VL 生成回答"""
...
def main():
    ...
    ap.add_argument("--out_csv", type=str, default="/data/jianzhiy/Project/results/results_qwen3_vl.csv")
    ...
    with open(args.out_csv, "w", newline="", encoding="utf-8") as f:
        ...
        for i, it in enumerate(items):
            ...
            for tone in tones:
                ...
                try:
                    resp = generate_answer_qwen3(model, processor, img, prompt, args.max_new_tokens)
                except Exception as e:
                    resp = f"[GEN_ERROR] {e}"
                    print(f"    Error: {e}")
